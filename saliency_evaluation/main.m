...
dataset = 'LFSD';
gtPath = ['E:\data\LFSD/GT/'];
salPath = ['C:\Users\zhang\Desktop\Experiment\Our_saliencymap\PICNet\LFSD/'];
...
fprintf('(%s Dataset) Smeasure %.3f;Fmeasure %.3f;weighted_F: %.3f;Emeasure: %.3f; MAE: %.3f.\n',dataset, Sm,Fm,F_wm,Em, mae);
