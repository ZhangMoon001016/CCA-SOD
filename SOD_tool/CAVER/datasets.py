_RGBD_SOD_ROOT = "E:/2/data/STERE/"
_RGBT_SOD_ROOT = "<rgbtsod root>"

# RGB-D SOD
DUT_1 = dict(
    image=dict(path=f"{_RGBD_SOD_ROOT}RGB", suffix=".jpg"),
    depth=dict(path=f"{_RGBD_SOD_ROOT}depth", suffix=".jpg"),
    mask=dict(path=f"{_RGBD_SOD_ROOT}GT", suffix=".png"),
)
LFSD = dict(
...
NLPR_1= dict(
    image=dict(path=f"{_RGBD_SOD_ROOT}/NLPR/cls1/1/RGB", suffix=".jpg"),
    depth=dict(path=f"{_RGBD_SOD_ROOT}/NLPR/cls1/1/depth", suffix=".jpg"),
    mask=dict(path=f"{_RGBD_SOD_ROOT}/NLPR/cls1/1/GT", suffix=".png"),
