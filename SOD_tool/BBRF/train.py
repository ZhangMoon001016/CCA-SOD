...
def train(Dataset, Network):
    ...
    # dataset
    cfg = Dataset.Config(datapath=r'H:\code\DAT\data\360-SOD\train', savepath='model2',mode='train', batch=26,lr=0.04, momen=0.9,
                         decay=5e-4, epoch=64)
    ...
    # val dataloader
    val_cfg1 = Dataset.Config(datapath=r'H:\code\DAT\data\360-SOD\test', mode='test')
