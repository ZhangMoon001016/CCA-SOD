...
class Data(Dataset):
    def __init__(self, cfg):
        ...
        lst='E:/2/data/NJUK/RGB/'
        for each in os.listdir(lst):
    ...
    def __getitem__(self, idx):
        ...
        print(name)
        tig='.jpg'
        #if self.cfg.datapath=='E:/data/NLPR/cls_2/1/RGB/':
            #tig='.png'
        print(self.cfg.datapath)
        image = cv2.imread(self.cfg.datapath+'/RGB/'+name+tig)[:,:,::-1].astype(np.float32)
    ...
    def collate(self, batch):
        size =[224, 256, 288, 320, 352][np.random.randint(0, 5)]#[320, 352, 384, 416, 448][np.random.randint(0, 5)]#d
...
if __name__=='__main__':
    ...
    cfg  = Config(mode='test', datapath='E:/2/data/NJUK/')
    data = Data(cfg)
    for i in range(1000):
        image, mask,shape,name = data[i]
